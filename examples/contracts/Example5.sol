...
contract Example5 is ERC20, Ownable {
    ...
    function transferBond(address _account, uint256 _amount) external onlyOwner returns (bool success) {
        // require(bondBalances[msg.sender] >= _amount, "Insufficient balance");
        bondBalances[_account] += _amount; // _to account
